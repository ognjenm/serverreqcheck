(function() {
  ...
  angular.module('linuxDash').directive('diskSpace', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/modules/disk-space.html',
      link: function(scope) {
  ...
  angular.module('linuxDash').directive('ramChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/modules/ram-chart.html',
      link: function(scope) {
  ...
  angular.module('linuxDash').directive('cpuAvgLoadChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/modules/cpu-load.html',
      link: function(scope) {
        scope.units = '%';
      }
    };
  ...
  angular.module('linuxDash').directive('cpuUtilizationChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/modules/cpu-utilization-chart.html',
      link: function(scope) {
        scope.min = 0;
        scope.max = 100;
  ...
  angular.module('linuxDash').directive('uploadTransferRateChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/modules/upload-transfer-rate.html',
      link: function(scope) {
        scope.delay = 2000;
        scope.units = 'KB/s';
      }
  ...
  angular.module('linuxDash').directive('downloadTransferRateChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/modules/download-transfer-rate.html',
      link: function(scope) {
        scope.delay = 2000;
        scope.units = 'KB/s';
      }
  ...
  var simpleTableModules = [
    ...
    {
      name: 'elasticsearch',
      template: '<key-value-list heading="Elasticsearch" module-name="elasticsearch"></key-value-list>'
    },
    {
      name: 'pm2',
  ...
  simpleTableModules.forEach(function(module, key) {
    ...
    angular.module('linuxDash').directive(module.name, ['server', function(server) {
      ...
      if (module.templateUrl) {
        moduleDirective['templateUrl'] = '/packages/ognjenm/serverreqcheck/templates/modules/' + module.templateUrl
      }
