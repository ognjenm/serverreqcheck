(function() {
  ...
  angular.module('linuxDash').config(['$routeProvider',
    function($routeProvider) {
      ...
      $routeProvider.
      when('/loading', {
        templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/loading.html',
      ...
      when('/system-status', {
        templateUrl: '/packages/ognjenm/serverreqcheck/templates/sections/system-status.html',
      }).
      when('/basic-info', {
        templateUrl: '/packages/ognjenm/serverreqcheck/templates/sections/basic-info.html',
      }).
      when('/network', {
        templateUrl: '/packages/ognjenm/serverreqcheck/templates/sections/network.html',
      }).
      when('/accounts', {
        templateUrl: '/packages/ognjenm/serverreqcheck/templates/sections/accounts.html',
      }).
      when('/apps', {
        templateUrl: '/packages/ognjenm/serverreqcheck/templates/sections/applications.html',
      }).
      otherwise({
        redirectTo: '/loading'
      });
  ...
  angular.module('linuxDash').service('server', ['$http', '$rootScope', '$location', function($http, $rootScope, $location) {
    ...
    this.get = function(moduleName, callback) {
      ...
      // otherwise
        ...
        var moduleAddress = '/serverinfo?module=' + moduleName;
  ...
  angular.module('linuxDash').directive('navBar', function($location) {
    return {
      restrict: 'E',
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/navbar.html',
      link: function(scope) {
        scope.items = [
          'system-status',
          'basic-info',
  ...
  angular.module('linuxDash').directive('topBar', function() {
    return {
      ...
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/ui-elements/top-bar.html',
  ...
  angular.module('linuxDash').directive('lastUpdate', function() {
    return {
      ...
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/ui-elements/last-update.html'
    };
  });
  ...
  angular.module('linuxDash').directive('tableData', ['server', '$rootScope', function(server, $rootScope) {
    return {
      ...
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/table-data-plugin.html',
  ...
  angular.module('linuxDash').directive('keyValueList', ['server', '$rootScope', function(server, $rootScope) {
    return {
      ...
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/key-value-list-plugin.html',
      link: function(scope, element) {
  ...
  angular.module('linuxDash').directive('lineChartPlugin', ['$interval', '$compile', 'server', function($interval, $compile, server) {
    return {
      ...
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/line-chart-plugin.html',
      link: function(scope, element) {
  ...
  angular.module('linuxDash').directive('multiLineChartPlugin', ['$interval', '$compile', 'server', function($interval, $compile, server) {
    return {
      ...
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/multi-line-chart-plugin.html',
      link: function(scope, element) {
  ...
  angular.module('linuxDash').directive('plugin', function() {
    return {
      restrict: 'E',
      transclude: true,
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/base-plugin.html'
    }
  });
  ...
  angular.module('linuxDash').directive('progressBarPlugin', function() {
    return {
      ...
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/progress-bar-plugin.html'
    };
  });
  ...
  angular.module('linuxDash').directive('themeSwitcher', ['$location', function($location) {
    return {
      restrict: 'E',
      templateUrl: '/packages/ognjenm/serverreqcheck/templates/app/theme-switcher.html',
      link: function(scope) {
        ...
        scope.switchTheme = function(theme) {
          ...
          theme.selected = true;
          document.getElementsByTagName('html')[0].className = 'old';
